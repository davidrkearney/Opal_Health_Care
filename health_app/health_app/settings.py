...
SECRET_KEY = 'ja_cx656z=w($g*7t5-wrzz4ijryjfx9$v)xp#hbp^g$*_84z-'
...
COVERAGE_EXCLUDE_MODULES = (
    'health_app.migrations',
    'health_app.tests',
    'health_app.local_settings',
    'opal.migrations',
    'opal.tests',
    'opal.wsgi',
)
...
DEFAULT_DOMAIN = 'http://health_app.com/'


# ========== PROJECT ==========
OPAL_BRAND_NAME = 'health_app'
